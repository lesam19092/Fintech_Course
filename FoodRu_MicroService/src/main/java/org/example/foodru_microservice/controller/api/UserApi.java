...
public interface UserApi {
    ...
    @Operation(summary = "Add a meal ", description = "Add a meal to a user menu  meal ID and menu name for the authenticated user")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Add a meal to menu", description = "Add a meal to a specific menu by meal ID and menu name for the authenticated user")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Meal added to menu successfully",
                    content = @Content(mediaType = "application/json")),
            @ApiResponse(responseCode = "401", description = "Unauthorized access",
    ...
    @Operation(summary = "Create a menu", description = "Create a new menu for the authenticated user")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get all meals", description = "Retrieve all meals for the authenticated user")
    @ApiResponses(value = {
