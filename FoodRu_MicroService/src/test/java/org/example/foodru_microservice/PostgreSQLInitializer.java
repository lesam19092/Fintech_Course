...
public class PostgreSQLInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    public void initialize(ConfigurableApplicationContext context) {
        ...
        TestPropertyValues.of(
                "spring.s3.serviceEndpoin=https://storage.yandexcloud.net",
                "spring.s3.signingRegion=ru-central1",
                "spring.s3.bucketName=bucketName",
                "spring.s3.accessKeyId=accessKeyId",
                "spring.s3.secretAccessKey=secretAccessKey"
        ).applyTo(context.getEnvironment());
