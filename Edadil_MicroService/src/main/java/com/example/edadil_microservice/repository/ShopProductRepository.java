...
public interface ShopProductRepository extends JpaRepository<ShopProduct, Integer> {
    ...
    Optional<ShopProduct> findShopProductsByCompanyIdAndCityAndShopId(Integer companyId, String city, Integer shopId);
    ...
    Optional<ShopProduct> findProductsInShopByFirmAndCompany(Integer firmId, Integer companyId, Integer shopId);
}